  ...
  (lib.mkIf pkgs.stdenv.isLinux {
    ...
    programs.autorandr = {
      ...
      profiles = {
        ...
        la = {
          # xrandr --output DVI-D-0 --off --output HDMI-0 --mode 3840x2160 --pos 1920x0 --rotate normal
          # --output HDMI-1 --off --output DP-0 --primary --mode 2560x1440 --pos 2560x2160 --rotate normal
          # --output DP-1 --off --output DP-2 --mode 2560x1440 --pos 0x2160 --rotate normal
          # --output DP-3 --off --output DP-1-1 --mode 2560x1440 --pos 5120x2160 --rotate normal
