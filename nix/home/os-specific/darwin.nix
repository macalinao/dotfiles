...
in
{
  config = lib.mkIf pkgs.stdenv.isDarwin {
    ...
    # One Camera One Lens scene-referred styles. Vendored into the repo (no
    # upstream license / Google Drive only, so they can't be fetched
    # declaratively); see config/darktable/styles/onecameraonelens/README.md.
    # Same one-time import as t3mujinpack above.
    home.file.".config/darktable/styles-packs/onecameraonelens" = {
      source = ../../../config/darktable/styles/onecameraonelens;
      recursive = true;
    };
