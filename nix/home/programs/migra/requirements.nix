...
let
  ...
  generated = self: {
    "migra" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://files.pythonhosted.org/packages/e1/ec/cf438a10d3117db410d7dd725f01c1d213c2261e6f80bb87bf0958d6aa81/migra-1.0.1587214226.tar.gz";
        sha256 =
          "e4c5a9e3be73e2b20a4c28e0c163483986f334b86b89a2547673f7701d58e6b7";
      };
      doCheck = commonDoCheck;
      format = "pyproject";
      buildInputs = commonBuildInputs ++ [ ];
      propagatedBuildInputs = [ self."schemainspect" self."six" self."sqlbag" ];
    ...
    "psycopg2-binary" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://files.pythonhosted.org/packages/97/00/ed4c82364741031d745867f83820d4f373aa891098a5785841850491c9ba/psycopg2-binary-2.8.5.tar.gz";
        sha256 =
          "ccdc6a87f32b491129ada4b87a43b1895cf2c20fdb7f98ad979647506ffc41b6";
      };
      doCheck = commonDoCheck;
      format = "setuptools";
      buildInputs = commonBuildInputs ++ [ ];
    ...
    "schemainspect" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://files.pythonhosted.org/packages/92/00/1d3464020bfd69e04ed340c760ea4250be2ae626c94a222c5319a820500a/schemainspect-0.1.1587214651.tar.gz";
        sha256 =
          "53003b47a7d210ea9c5fa8ccb86598fecbd6cd99cace40298c0825f14eb9917c";
      };
      doCheck = commonDoCheck;
      format = "pyproject";
      buildInputs = commonBuildInputs ++ [ ];
      propagatedBuildInputs = [ self."six" self."sqlalchemy" ];
      meta = with pkgs.stdenv.lib; {
    ...
    "setuptools" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://files.pythonhosted.org/packages/b5/96/af1686ea8c1e503f4a81223d4a3410e7587fd52df03083de24161d0df7d4/setuptools-46.1.3.zip";
        sha256 =
    ...
    "sqlalchemy" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://files.pythonhosted.org/packages/7f/4b/adfb1f03da7f50db054a5b728d32dbfae8937754cfa159efa0216a3758d1/SQLAlchemy-1.3.16.tar.gz";
        sha256 =
          "7224e126c00b8178dfd227bc337ba5e754b197a3867d33b9f30dc0208f773d70";
      };
      doCheck = commonDoCheck;
      format = "setuptools";
      buildInputs = commonBuildInputs ++ [ ];
    ...
    "sqlbag" = python.mkDerivation {
      ...
      src = pkgs.fetchurl {
        url =
          "https://files.pythonhosted.org/packages/00/2a/39299296352f561cfa20ccd579cfafaf9bdb3df0626959a57c2c2b7042d4/sqlbag-0.1.1579049654.tar.gz";
        sha256 =
          "bf1aba13a062b0ef61d37ab6f4aa8808bc4bd830e0c14178238ac8185d298f42";
      };
      doCheck = commonDoCheck;
      format = "setuptools";
      buildInputs = commonBuildInputs ++ [ ];
      propagatedBuildInputs = [ self."pathlib" self."six" self."sqlalchemy" ];
      meta = with pkgs.stdenv.lib; {
